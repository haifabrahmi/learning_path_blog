class BlogPostsController < ApplicationController
  ...
  def create
    ...
    if @blog_post.save
      ...
      render :new, status: :unprocessable_entity  # Réaffiche le formulaire avec un statut 422
    end
  end
  def edit
    # @blog_post = BlogPost.find(params[:id])
  ...
  def update
    ...
    if @blog_post.update(blog_post_params)
      ...
      render :edit, status: :unprocessable_entity  # Réaffiche le formulaire avec un statut 422
